...
export default function AIMentorPage() {
  ...
  if (!isAuthed) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
        ...
        <button className="btn-primary px-5 py-2 text-sm" onClick={openAuthModal}>
          Sign In
        </button>
      </div>
    );
  ...
  return (
    <div className="flex h-[calc(100vh-var(--navbar-height,64px))] overflow-hidden">
      {/* Sidebar */}
      <div className="hidden md:flex flex-col w-56 border-r border-[var(--panel-border)] flex-shrink-0">
        <ConversationSidebar
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--panel-border)] flex-shrink-0">
          <div>
            <h1 className="text-sm font-semibold">AI Economic Mentor</h1>
          ...
          <div className="flex items-center gap-2">
            {activeConvId && (
              <>
                <button
                  type="button"
                  className="tab text-xs px-3 py-1"
        ...
        {/* Input */}
        <div className="flex-shrink-0 px-4 py-3 border-t border-[var(--panel-border)]">
          <div className="flex gap-2 items-end">
            <textarea
              ref={inputRef}
              rows={1}
              className="flex-1 input resize-none text-sm py-2 leading-relaxed"
      ...
      {/* Context panel */}
      <div className="hidden lg:flex flex-col w-52 border-l border-[var(--panel-border)] flex-shrink-0">
